...
import { Camera, CameraOff, LogOut, Mic, MicOff, Radio, Send, Users } from "lucide-react";
...
export default function MediaTestRoom(){
 ...
 async function startTest(){
   ...
   if(error)setNotice(error.message);else{setRoom(data.id);setNotice("Test live is active. Authenticated members can join this room and use real-time chat.")}
 }
 async function send(){
 ...
 return <main className="screen">
  ...
  <section className="ejay-host-card">
